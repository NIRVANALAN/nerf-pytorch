...
```
After training for 200k iterations (~8 hours on a single 2080 Ti, ~21 hours on a single GTX Titan X), you can find the following video at `logs/fern_test/fern_test_spiral_200000_rgb.mp4` and `logs/fern_test/fern_test_spiral_200000_disp.mp4`
